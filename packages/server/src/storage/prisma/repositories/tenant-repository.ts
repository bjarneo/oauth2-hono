  ...
  async create(input: CreateTenantInput): Promise<Tenant> {
    ...
    const row = await prisma.tenant.create({
      data: {
        ...
        metadata: input.metadata as unknown as Parameters<typeof prisma.tenant.create>[0]['data']['metadata'],
      },
    });
  ...
  async update(id: string, input: UpdateTenantInput): Promise<Tenant> {
    ...
    const row = await prisma.tenant.update({
      ...
      data: {
        ...
        allowedRedirectUriPatterns: input.allowedRedirectUriPatterns,
        metadata: input.metadata as unknown as Parameters<typeof prisma.tenant.update>[0]['data']['metadata'],
      },
    });
