...
export * from './identity-provider-storage.js';
export * from './federated-identity-storage.js';
...
import type { IIdentityProviderStorage } from './identity-provider-storage.js';
import type { IFederatedIdentityStorage } from './federated-identity-storage.js';
...
export interface IStorage {
  ...
  identityProviders?: IIdentityProviderStorage;
  federatedIdentities?: IFederatedIdentityStorage;
}
