...
import { setupTestContext, resetUser, basicAuth, type TestContext, type DeviceCodeResponse, type TokenResponse, type ErrorResponse } from '../test-setup.js';
...
describe('Device Code Grant', () => {
  ...
  it('should return authorization_pending while waiting', async () => {
    ...
    const { device_code } = await deviceRes.json() as DeviceCodeResponse;
    ...
    const body = await tokenRes.json() as ErrorResponse;
...
describe('Device Code Polling', () => {
  ...
  it('should return slow_down when polling too fast', async () => {
    ...
    const { device_code, interval } = await deviceRes.json() as DeviceCodeResponse;
    ...
    const body1 = await poll1.json() as ErrorResponse;
    ...
    const body2 = await poll2.json() as ErrorResponse;
